...
function ArticleForm() {
  ...
  return (
    <div className={classes['article-form']}>
      <div className={classes.header}>{id ? 'Edit article' : 'Create new article'}</div>
      ...
      <div className={classes.main}>
        ...
        >
          ...
          <Form.Item name="text" rules={[{ required: true, message: 'Please input text' }]}>
                ...
                {fields.map((field, i) => (
                  <Form.Item key={field.key}>
                    ...
                    <Button
                      ...
                      style={{ width: 120, marginLeft: 20, borderRadius: 5 }}
                    >
                      Delete
                    </Button>
                    {i === fields.length - 1 ? (
